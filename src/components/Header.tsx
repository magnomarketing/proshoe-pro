...
const navigation = [
  ...
  { name: 'Nuestros Compromisos', href: '/nuestros-compromisos' },
          ...
          <Link to="/" className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-primary-foreground/80 hidden sm:block">
                Maquila y fabricación de calzado
              </p>
            </div>
          </Link>
            ...
            <div className="flex flex-col space-y-4">
              {navigation.map((item) => (
                <Link
                  key={item.name}
                  to={item.href}
                  className={`text-primary-foreground hover:text-accent transition-colors py-2 ${
